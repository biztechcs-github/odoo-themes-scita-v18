...
'use strict';
    ...
    publicWidget.registry.crafito_cart_popup = publicWidget.Widget.extend({
        selector: '#wrapwrap',
        init: function () {
        ...
        _onChangeQuantity: function (ev){
            ...
            rpc.query({
                ...
                $.get("/shop/cart", {
                    ...
                    $(".mycart-popover .crafito_cart_popup_remove").off('click').on('click',function(ev) {
                        ev.preventDefault();
        ...
        _onMouseEnter: function (ev) {
            ...
            timeout = setTimeout(function () {
                ...
                self._popoverRPC = $.get("/shop/cart", {
                    ...
                    var cartPopup = new publicWidget.registry.crafito_cart_popup();
