...
class ProductCategorySlider(models.Model):
    ...
    _description = "Add product slider configration"
...
class BlogSlider(models.Model):
    ...
    _description = "Add Blog slider configration"
...
class MultiSlider(models.Model):
    ...
    _description = "Add Multi slider configration"
...
class CategorySlider(models.Model):
    ...
    _description = "Add category slider configration"
...
class FeatureProductSlider(models.Model):
    ...
    _description = 'feature product slider config'
    ...
    active = fields.Boolean(string="Active", default=True)
    feature_name = fields.Char(string="Featured Product Slider Label", default='Featured Products', required=True, translate=True,
    ...
    feature_products_collections = fields.Many2many('product.template', 'theme_mobicraft_feature_products_collections_slider_rel',
                                                    'slider_id', 'prod_id', required=True, string="Featured Products Collections")

    on_sale_name = fields.Char(string="On Sale Slider Label", default='On Sale', required=True, translate=True,
    ...
    on_sale_collections = fields.Many2many('product.template', 'theme_mobicraft_on_sale_name_collections_slider_rel',
                                           'slider_id', 'prod_id', required=True, string="On Sale Products Collections")

    random_name = fields.Char(string="Random Product Slider Label", default='Random Products', required=True, translate=True,
    ...
    random_products_collections = fields.Many2many('product.template', 'theme_mobicraft_random_products_collections_slider_rel',
                                                   'slider_id', 'prod_id', required=True, string="Random Products Collections")

    low_price_name = fields.Char(string="Low Price Slider Label", default='Low Price', required=True, translate=True,
    ...
    low_price_collections = fields.Many2many('product.template', 'theme_mobicraft_low_price_products_collections_slider_rel',
                                             'slider_id', 'prod_id', required=True, string="Low Price Products Collections")
