    	  ...
    	  if(date != "nan")
    		  ...
    		  var x = setInterval(function() {
    				...
    				if(self.$target.find(".counter_timer_div"))
    				{
						...
						var append_data="<div class='counter_timer_div'><span class='col-lg-3 col-md-3 col-sm-3 col-3 text-center timer_col'><div class='box_degit'><span id='days' class='d-count  t_days_hr_min_sec_digit o_default_snippet_text'>"+	days +"</span><span id='day_lbl' class='d-block'>DAYS</span></div></span><span class='col-lg-3 col-md-3 col-sm-3 col-3 text-center timer_col'><div class='box_degit'><span id='hours' class='d-count  t_days_hr_min_sec_digit o_default_snippet_text'>"+hours+"</span><span id='h_lbl' class='d-block'>HOURS</span></div></span><span class='col-lg-3 col-md-3 col-sm-3 col-3 text-center timer_col'><div class='box_degit'><span id='minutes' class='d-count t_days_hr_min_sec_digit o_default_snippet_text'>"+minutes+"</span><span id='m_lbl' class=' d-block'>MINS</span></div></span><span class='col-lg-3 col-md-3 col-sm-3 col-3 text-center timer_col'><div class='box_degit'><span id='seconds' class='d-count t_days_hr_min_sec_digit o_default_snippet_text'>"+seconds+"</span><span id='s_lbl' class='d-block'>SECS</span></div></span></div>";
